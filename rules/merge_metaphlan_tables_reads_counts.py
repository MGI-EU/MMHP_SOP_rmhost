...
# ==============================================================================
# 2019-01-14
# you can choose abundance or reads counts to merge, now
# Tianliu(tianliu@genomics.cn)
#
        ...
        with open(f) as csvfile:
            ...
            for astrLine in iIn:
                if astrLine[0].startswith('#'):
                    dCol = astrLine.index('estimated_number_of_reads_from_the_clade') if 'estimated_number_of_reads_from_the_clade' in astrLine else None
                    continue
